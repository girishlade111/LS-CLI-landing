...
const features = [
  {
    ...
    description:
      "Automatically selects the optimal model for each task based on complexity, context length, and cost constraints. Routes coding tasks to Qwen, debugging to DeepSeek, and long-context analysis to Kimi — all transparently.",
  },
  {
    icon: Code2,
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group rounded border border-border-subtle bg-surface p-6 transition-colors hover:border-accent/20"
            >
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded bg-accent/10 transition-colors group-hover:bg-accent/15">
        ...
        <div className="rounded border border-border-subtle bg-surface p-10 text-center md:p-14">
          ...
          >
            ...
            <p className="mx-auto mt-3 max-w-md text-text-muted">
              The feature set is actively expanding. Join the early access list to
              get notified when new capabilities are available.
            </p>
